---
name: ccbell-nightly:test
description: Test ccbell-nightly sound notifications
argument-hint: "[stop|permission_prompt|idle_prompt|subagent|all]"
allowed-tools: ["Read", "Bash"]
---

# Test ccbell-nightly Sounds
...
```
## ccbell-nightly Sound Test Results
...
To change sounds, run /ccbell-nightly:configure
```
...
6. **Enable debug mode:** Set `"debug": true` in config and check `~/.claude/ccbell-nightly.log`
...
This confirms audio output is working independent of ccbell-nightly config.
