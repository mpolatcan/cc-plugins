---
name: ccbell-nightly:disable
description: Disable ccbell-nightly sound notifications
allowed-tools: ["Read", "Write", "Bash"]
---

# Disable ccbell-nightly

Disable ccbell-nightly sound notifications.
...
Tell the user:
```
ccbell-nightly sound notifications disabled.

No sounds will play until you run /ccbell-nightly:enable.
