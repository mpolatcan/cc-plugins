---
name: ccbell-nightly:profile
description: Switch between ccbell-nightly sound profiles
argument-hint: "[default|focus|work|loud|silent]"
allowed-tools: ["Read", "Write", "AskUserQuestion", "Bash"]
---

# Switch ccbell-nightly Profile
...
```bash
GLOBAL_CONFIG="$HOME/.claude/ccbell-nightly.config.json"
...
Use /ccbell-nightly:test to hear your new notification sounds.
```
