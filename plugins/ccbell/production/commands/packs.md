...
```bash
/ccbell:packs browse                    # Browse official sound packs
/ccbell:packs preview minimal           # Preview pack sounds before installing
/ccbell:packs list                      # List installed sound packs
/ccbell:packs install minimal           # Install an official pack from catalog
/ccbell:packs install --url <url>       # Install a user-generated pack from URL
...
Install a pack: /ccbell:packs install <pack_id>
Preview a pack: /ccbell:packs preview <pack_id>
...
4. Extract to `~/.claude/ccbell/packs/<pack_id>/`
...
```bash
/ccbell:packs install --url <download_url>
```

Example:
```bash
/ccbell:packs install --url https://huggingface.co/spaces/mpolatcan/ccbell-sound-generator/api/download/my-pack
```
...
4. Move the extracted files to `~/.claude/ccbell/packs/<pack_id>/`
...
5. Run the command in Claude Code:
   ```bash
   /ccbell:packs install --url https://huggingface.co/.../api/download/my-pack
   ```
